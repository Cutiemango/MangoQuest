...
public class ModelConvProgress extends ConversationProgress
{
	...
	public ModelConvProgress(Player p, QuestConversation qc) {
		...
		page.add(new InteractiveText(I18n.locMsg("Conversation.Title", conv.getName()))
				.showText(I18n.locMsg("ConversationEditor.EndOfSimulation.ShowText")).clickCommand("/mq ce gui"));
		page.changeLine();
	...
	public void finish(boolean questFinish) {
		...
		getCurrentPage().add(new InteractiveText(I18n.locMsg("ConversationEditor.EndOfSimulation")).clickCommand("/mq ce gui")
				.showText(I18n.locMsg("ConversationEditor.EndOfSimulation.ShowText"))).changeLine();
