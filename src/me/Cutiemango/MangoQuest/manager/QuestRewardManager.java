...
public class QuestRewardManager implements Listener
{
	...
	public static void openEditMainGUI(Player p) {
		...
		Inventory inv = Bukkit.createInventory(null, 27,
				QuestChatManager.translateColor(I18n.locMsg("QuestReward.RewardEditTitle") + ChatColor.stripColor(q.getQuestName())));
	...
	private static ItemStack editRewardAmount(int amount) {
		...
		anvil.setLore(QuestUtil
				.createList(I18n.locMsg("QuestReward.CurrentRewardAmount", Integer.toString(amount), I18n.locMsg("QuestReward.ClickToEdit"))));
		return anvil.get();
	}
	...
	public static String getItemName(ItemStack item) {
		if (item == null)
			...
			return QuestChatManager.translateColor(QuestUtil.getItemName(item) + " &f" + ChatColor
					.stripColor(I18n.locMsg("QuestEditor.Amount", Integer.toString(item.getAmount()))));
	}
